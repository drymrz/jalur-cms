...
<footer
    ...
    <div class="wrapper w-[75%] flex flex-col md:flex-row gap-[32px] justify-between items-center">
        ...
        <div class="select-wrapper relative">
            <select name="" id=""
                class="bg-jalur-dark py-[14px] pl-[20px] pr-[40px] rounded-[50px] border-[2px] text-[13px] font-bold appearance-none">
                <option value="en" selected>English</option>
                <option value="id">Bahasa Indonesia</option>
            </select>
            <img class="absolute top-[50%] right-[10px]" style="transform: translate(-50%, -50%);"
                src="/icons/dropdown.svg" alt="">
        </div>
    </div>
</footer>
