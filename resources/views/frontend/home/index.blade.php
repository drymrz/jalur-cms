...
@section('content')
            ...
            <div class="text-wrapper relative h-[75vh] xl:h-[92vh] flex items-center px-[24px] xl:pl-[148px] w-full">
                <div class="text-content flex flex-col gap-[18px]">
                    <h1
                        ...
                        On The Go With
                        Jalur!</h1>
                    <p class="text-[16px] md:text-[18px] leading-[22px] md:leading-[25px] text-white md:max-w-[40%]">Plan
                        your trip and find
                        the mosque based
                        on
                        prayer times
    ...
    <section class="hero-title-section py-[24px] md:py-[48px]">
        <div class="img-top-wrapper">
            ...
            <img class="hidden md:block xl:hidden w-screen md:px-[32px] xl:px-0" src="/img/image-top-md.svg" alt="">
        ...
        <div class="text-wrapper flex item-center justify-center py-[24px] md:py-[36px]">
            <h2 class="text-[24px] md:text-[32px] xl:text-[48px] text-center leading-[1] xl:leading-[48px] max-w-[80%]">
                ...
                Jalur offers a solution that blends faith with the practicalities of travel, ensuring your spiritual journey
                is as smooth as your physical one.</h2>
        </div>
        <div class="img-bot-wrapper">
